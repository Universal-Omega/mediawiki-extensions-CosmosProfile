 ...
 * @ingroup Extensions
 */
class SpecialRemoveProfileAvatar extends SpecialPage {

	public function __construct() {
		parent::__construct( 'RemoveProfileAvatar' );
	}
	...
	private function showUserAvatar( $user_name ) {
		...
		$userIsPrivileged = $this->isUserPrivileged();
		$avatar = new ProfileAvatar( $user_id, 'l' );
		$output = '';
	...
	private function deleteImage( $id, $size ) {
		...
		$avatar = new ProfileAvatar( $id, $size );
